    ...
    return (
        <section className="relative w-full py-40 md:py-56 px-6 flex items-center justify-center bg-void z-20 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center gap-6 sm:gap-8 max-w-4xl mx-auto">
                <h2 className="font-sans font-bold text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-ghost tracking-tighter flex flex-col gap-2">
                    <span>Ready to transcend</span>
                    <span className="font-serif italic text-plasma font-normal text-5xl sm:text-6xl md:text-[8rem] lg:text-[9rem] leading-[0.8] block mb-4">boundaries?</span>
                </h2>
